...
from temp_reading import get_identity_data, get_device_ping_value
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # === Identity Info + Status (super rapat) ===
    ...
    def update_identity_info(self):
        ...
        status = "Online" if get_device_ping_value() != 800 else "Offline"
